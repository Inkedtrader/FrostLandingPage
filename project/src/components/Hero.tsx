...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    mainBg.src = 'https://images.unsplash.com/photo-1565058379802-bbe93b2f703a?auto=format&fit=crop&w=2070&q=80';
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1565058379802-bbe93b2f703a?auto=format&fit=crop&w=2070&q=80')`,
